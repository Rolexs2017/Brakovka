...
class MainWindow(QMainWindow):
    def __init__(
        ...
        *,
        ...
        # Kiosk / panel: no system title bar or window controls.
        self.setWindowFlags(
            Qt.WindowType.FramelessWindowHint | Qt.WindowType.Window
        )
        if self._fullscreen:
            # Layout stretches to whatever display is attached.
    ...
    def _on_nav_clicked(self, index: int) -> None:
        if index == SETTINGS_PAGE_INDEX:
            ...
            # Leaving settings locks the page again.
            self._settings_unlocked = False
    ...
    def _check_alarms(self, snap: MachineSnapshot) -> None:
        """Play alarm on rising edge of fault / error flags."""
        alarm_mask = int(
